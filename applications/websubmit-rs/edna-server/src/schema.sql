...
CREATE TABLE answers (id int NOT NULL AUTO_INCREMENT, email varchar(255), lec int, q int, answer text, submitted_at datetime, PRIMARY KEY (`id`), INDEX `email` (`email`), INDEX lec (lec)) engine = InnoDB;
